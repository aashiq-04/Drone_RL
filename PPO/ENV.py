...
from PPO.CONFIG import OBSTACLES,MAP_SIZE,MAX_ACTION
...
class DroneEnv3D(gym.Env):
    ...
    def reset(self, *, seed=None):
        ...
        return self.get_observation().astype(np.float32) #,{}  remove the hash after testing
    ...
    def check_collision(self,safety_distance=0.5):
        # print(abs(self.dmin)
